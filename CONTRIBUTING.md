...
This file describes the general process for maintaining source code for content published at [https://docs.rackspace.com/how-to/](https://docs.rackspace.com/how-to/).
...
Articles are grouped into one directory per product. Each directory contains one directory per article. Within the article directory are the content file and any images needed for the file.
