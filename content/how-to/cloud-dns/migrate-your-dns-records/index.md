...
If you are running Windows, see [Checking DNS records on Windows](/how-to/nslookup-checking-dns-records-on-windows). This article explains the steps to query the *primary name server* of the domain. The primary name server is the location where your DNS zone file is hosted.
...
[Use dig to query nameservers](/how-to/using-dig-to-query-nameservers) for a more in-depth guide.
...
- [How to Cloud DNS](/how-to/cloud-dns/)
- [Cloud DNS Supported record types](/how-to/rackspace-cloud-dns-additional-resources/)
