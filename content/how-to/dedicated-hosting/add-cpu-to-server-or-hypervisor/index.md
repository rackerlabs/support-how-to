...
**Step 1.** Log in to the [MyRackspace portal](https://login.rackspace.com/login) with
   ...
   <img width="409" alt="logincredentials" src="/source/how-to/add-cpu-to-server-or-hypervisor/hypervisor4.png">

**Step 2.** In the top navigation bar, choose **Support** > **Support Center**.

   <img width="941" alt="selectsupportcenter" src="/source/how-to/add-cpu-to-server-or-hypervisor/hypervisor5.png">

**Step 3.** Under **Common Request**, click **See All Templates**. The **See All Templates** displays list of all templates.

   <img width="958" alt="listoftemplates" src="/source/how-to/add-cpu-to-server-or-hypervisor/hypervisor6.png">

**Step 4.** From the **Common Request** menu, select **Add CPU to Server or Hypervisor**.

  <img width="249" alt="selectrequiredtemplate" src="/source/how-to/add-cpu-to-server-or-hypervisor/hypervisor7.png">
...
**Step 6.** In the **Preferred Maintenance Schedule** section, you can choose to have the
   ...
   <img width="275" alt="checkboxanytimetick" src="/source/how-to/add-cpu-to-server-or-hypervisor/hypervisor9.png">
   ...
   <img width="195" alt="deselectantimecheckbox" src="/source/how-to/add-cpu-to-server-or-hypervisor/hypervisor10.png">
