...
1. Log in to the [MyRackspace portal](https://login.rackspace.com/login) with
   ...
   <img width="409" alt="hypervisor4" src="/support/how-to/add-cpu-to-server-or-hypervisor/hypervisor4.png">

2. In the top navigation bar, choose **Support** > **Support Center**.

   <img width="941" alt="hypervisor5" src="/support/how-to/add-cpu-to-server-or-hypervisor/hypervisor5.png">

3. Under **Common Request**, click **See All Templates**. The **See All Templates** displays list of all templates.

   <img width="958" alt="hypervisor6" src="/support/how-to/add-cpu-to-server-or-hypervisor/hypervisor6.png">

5. From the **Common Request** menu, Select **Add CPU to Server or Hypervisor**.

  <img width="249" alt="hypervisor7" src="/support/how-to/add-cpu-to-server-or-hypervisor/hypervisor7.png">

6. In the **Issue Details** section, select a device from the drop-down menu and
   enter the number of CPUs that you want to add.

  <img width="524" alt="hypervisor8" src="/support/how-to/add-cpu-to-server-or-hypervisor/hypervisor8.png">
...
8. Click **Submit**.
   ...
   <img width="195" alt="hypervisor9" src="/support/how-to/add-cpu-to-server-or-hypervisor/hypervisor9.png">
