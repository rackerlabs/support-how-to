...
1. [Log](/how-to/connect-to-a-cloud-server/) in to
   the server.
...
- [Install IIS and configure a
  website](/how-to/install-iis-and-configure-a-website/)
- [Configure an IIS FTP
  site](/how-to/configure-an-iis-ftp-site/)
- [Install an SSL
  certificate](/how-to/install-an-ssl-certificate/)
- [IIS SNI overview](/how-to/iis-sni-overview/)
