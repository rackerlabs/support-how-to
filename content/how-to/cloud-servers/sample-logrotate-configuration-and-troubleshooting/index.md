...
If you have more log directories or files to add, insert them into that
list.
...
It can also be useful if you're convinced that logrotate should be rotating a log,
