  ...
  <div class="container">
    <div class="content home">
      ...
      <ul class="nav nav-tabs responsive-tabs filter-product-type row" id= "nav-tab" role="tablist">
        ...
        <div class="tablink"><a href="/how-to/account-management">Account Management</a></div>
      </ul>
    </div>
  </div>
    ...
    <div class="content home product-type product-type-cloud inactive" id="cloud-display">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4 icon cloudflare">
          <h4><a href="/how-to/rms-cloudflare/"><span>Cloudflare</span> with Rackspace Managed Services</a></h4>
        </div>
      </div>
      <hr />
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4 icon vmware">
          <h4><a href="/how-to/vmware-server-virtualization/"><span>VMware</span> Server Virtualization</a>
          </h4>
        </div>
      </div>
      <hr />
