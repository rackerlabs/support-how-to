...
![](Fig1-Ded.-LB-and-RCv3-Figure-Traffic-Flow-PNG-.5xhalf-border.png" width="599" height="484" />
...
2.  In the pop-up dialog box, select the check box for each load balancer pool to which you want to add the cloud server.
    ...
    ![](Fig3_REACH_LB_Pool_Modal_PNG_smaller-border.png" width="500" height="241" />
