...
1. On your phone, navigate to **Settings > More Networks**.
    ...
    ![](1710-4631_1_2.png" width="270" height="283" border="1" alt=""  />

2. Go to **Mobile Networks > Access Point Names**.

    ![](1710-4631_2_1.png" width="268" height="268" border="1" alt=""  />

    Only one APN should be listed.

    ![](1710-4631_3_1.png" width="270" height="114" border="1" alt=""  />
...
4. Select the new APN.
    ...
    ![](1710-4631_4_1.png" width="268" height="128" border="1" alt=""  />
