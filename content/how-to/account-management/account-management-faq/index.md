...
Yes, at this time more features are available through the API. For more information about using the API for RBAC, refer the [Rackspace API Documentation](https://docs.rackspace.com/docs/).
{{</ accordion >}}
...
You cannot link these permissions at this time. We plan to address having a common permission scheme among dedicated, hybrid, and cloud customers in the future.
{{</ accordion >}}
...
Users with the appropriate roles can access all of an account's resources. In other words, account users share a pool of resources that other account users may have access to rather than having their own set of resources.
{{</ accordion >}}
...
If you do not have a VAT ID number or choose not to supply one, Rackspace applies the appropriate tax handling to your invoice. It is in your best interest to supply your VAT ID number because the tax
