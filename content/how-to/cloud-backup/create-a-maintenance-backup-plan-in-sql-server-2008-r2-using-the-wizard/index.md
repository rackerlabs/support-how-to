...
4.  Click the **General** tab, and select **Automatic** as the startup type,
    ...
    <img src="CheckSQLServerAgent3.png" width="439" height="188" />
...
2.  In the Object Explorer pane, expand the **Management** folder, right-click on **Maintenance Plans**, and select **Maintenance Plan Wizard**.
    ...
    <img src="CreatingtheMaintenancePlan1_0.png" width="408" height="587" />
...
5.  On the Select Maintenance Tasks page, select the **Back Up
    ...
    **Next**.
    ...
    <img src="Creatingthemaintenanceplan4.png" width="576" height="512" />
...
6.  To configure the scheduling options for this task, click **Change**
    ...
    <img src="fullbackupsetttings1.png" width="589" height="941" />
...
10. Under **Duration**, adjust the **Start** and **End** dates. In the
    ...
    <img src="fullbackupsetttings2.png" width="680" height="591" />
...
11. Under **Duration**, adjust the **Start date** and **End date**
    ...
    <img src="TransactionLogBackupSettings2.png" width="594" height="518" />
...
10. Select the **Delete files based on the age of the file at task run
    ...
    <img src="TransactionLogCleanupTask3.png" width="484" height="566" />
...
13. Double-click the connected green line.
    ...
    <img src="TransactionLogCleanupTask4.png" width="353" height="287" />
...
14. In the Precedence Constraint Editor, set **Value** to Completion.
    ...
    <img src="TransactionLogCleanupTask5.png" width="445" height="370" />

15. Click **OK** to return to the Management Studio main window.
    The line should now appear blue.

    <img src="TransactionLogCleanupTask6.png" width="366" height="309" />
...
1.  In the Object Explorer pane, right-click the failed sub plan and
    ...
    <img src="Errors2_0.png" width="604" height="320" />
...
2.  Click the row for the failed job.
    ...
    <img src="Errors3.png" width="991" height="425" />
