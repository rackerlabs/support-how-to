...
- A Cloud Server running RHEL or CentOS based distributions.
...
Run the following command to verify that you added the userto the wheel group:
...
without adding the user to the wheel or admin group. 
