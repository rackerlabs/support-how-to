...
Attach Volume to Server<br /><br /> **Note:** The user must also have a Cloud Block Storage Admin or Creator role. | `POST /servers/{id}/os-volume_attachments` | **Creator Admin**	| Attaches a volume to the specified server.
