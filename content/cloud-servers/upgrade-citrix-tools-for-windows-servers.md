...
2. Extract the archive named **xstools-6.0.zip** to a local directory, such as **C:\**.
   ...
   <img src="{% asset_path cloud-servers/upgrade-citrix-tools-for-windows-cloud-servers/extract-xen-tools.png %}" alt="" />
...
1. Extract the archive named, **Rackspace-Cloud-Servers-Agent-Latest.zip**.
   ...
   <img src="{% asset_path cloud-servers/upgrade-citrix-tools-for-windows-cloud-servers/extract-agent.png %}" alt="" />
