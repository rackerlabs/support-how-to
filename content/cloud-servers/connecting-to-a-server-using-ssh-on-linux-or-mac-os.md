...
a computer running Linux&reg; or MacOS&reg; X by using SSH. It also discusses
...
MacOS X Terminal. To make SSH connections from Windows&reg;, you can use a
...
5.  Enter a key name to remind you which computer this key is for; for
    example, **Work Laptop**.
