...
downloaded via the following link: [Web PI](http://www.microsoft.com/web/downloads/platform.aspx)
...
modifications.
  ...
  **Note**: Explaining the php directives that can be modified is beyond
