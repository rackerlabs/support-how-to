...
2. From the Server Manager Dashboard click **Add Roles and Features**.
  ...
  <img src="{% asset_path cloud-servers/installing-ftp-on-windows-server-2012-r2/server_manager_iis1.png %}" width="746" height="560" />
...
features provide additional functionality for a given role.
  ...
  <img src="{% asset_path cloud-servers/installing-ftp-on-windows-server-2012-r2/role_based_0.png %}" width="749" height="531" />

4. The current server will be selected by default. Click **Next**
to move to the Server Roles selection tab.

  <img src="{% asset_path cloud-servers/installing-ftp-on-windows-server-2012-r2/server_selection_0.png %}" width="749" height="531" />
...
each feature.
  ...
  <img src="{% asset_path cloud-servers/installing-ftp-on-windows-server-2012-r2/features_ftp.png %}" width="755" height="567" />

7. Review your installation and click **Install**.

  <img src="{% asset_path cloud-servers/installing-ftp-on-windows-server-2012-r2/install_ftp.png %}" width="755" height="566" />
...
installation is complete the Wizard will present a notification.
  ...
  <img src="{% asset_path cloud-servers/installing-ftp-on-windows-server-2012-r2/ftp_install_success.png %}" width="755" height="566" />
