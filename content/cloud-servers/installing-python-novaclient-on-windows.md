...
To run python-novaclient you'll need python 2.6 or later installed on your system (if using python 3, be sure to download the related packages).  You can run the client from either a desktop machine or from a remote system, like a Cloud Server.
