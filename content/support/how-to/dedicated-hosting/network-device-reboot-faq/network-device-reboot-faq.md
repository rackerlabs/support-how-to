...
Yes, you can schedule a reboot to occur. We have a "Schedule Reboot" feature built into our MyRackspace Portal. For more information about scheduling a reboot, see the [Scheduling a network device reboot](https://support.rackspace.com/support/how-to/schedule-network-device-reboot/) article.
