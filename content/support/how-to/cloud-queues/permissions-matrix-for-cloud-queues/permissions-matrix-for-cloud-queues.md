...
[Role-based Access Control (RBAC) permissions matrix for Cloud Hosting](https://support.rackspace.com/support/how-to/permissions-matrix-for-role-based-access-control-rbac/)
