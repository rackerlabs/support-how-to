...
See [Detach and delete Cloud Block Storage volumes](https://support.rackspace.com/support/how-to/detach-and-delete-cloud-block-storage-volumes/) for instructions.
...
3. Set the service to start automatically, and then start the service.
   ...
   <img src="attach-cbs-to-win-onmetal-1.png" alt="" />
...
5. Open the iSCSI initiator, click on the second tab, **Discovery**, and then
   ...
   <img src="attach-cbs-to-win-onmetal-2.png" alt="" />
...
6. Enter the IP address (the `portal` IP address and port, which you noted
   ...
   <img src="attach-cbs-to-win-onmetal-3.png" alt="" />
...
7. Click the **Targets** page, and enter the target ICQ (the `targetname`, which
   ...
   <img src="attach-cbs-to-win-onmetal-4.png" alt="" />
...
10. Select **Storage** -> **Disk Management** to see all of your drives.
   ...
   <img src="attach-cbs-to-win-onmetal-5.png" alt="" />
