...
You should promote the server to a Domain Controller. See [Install Active Directory on Windows Server 2012](https://support.rackspace.com/support/how-to/installing-active-directory-on-windows-server-2012/).

### Limitations

This task does not fall within the [Windows Spheres of Support for Dedicated and Managed Operations](https://support.rackspace.com/support/how-to/windows-spheres-of-support-for-dedicated-and-managed-ops/).
...
- [Install licensing services to Cloud Servers for Windows 2008 and Windows 2008 R2 to prevent a licensing error](https://support.rackspace.com/support/how-to/install-licensing-services-to-cloud-servers-for-windows-2008-to-prevent-licensing-error/)
