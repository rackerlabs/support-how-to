...
and [Generate RSA keys with SSH by using PuTTYgen](https://support.rackspace.com/support/how-to/generating-rsa-keys-with-ssh-puttygen/).
...
To complete this process, you need the following software applications:
 ...
 [Connect to a server by using SSH on Linux or Mac OS X](https://support.rackspace.com/support/how-to/connecting-to-a-server-using-ssh-on-linux-or-mac-os/).
