...
[Boot a server from a Cloud Block Storage volume](https://support.rackspace.com/support/how-to/boot-a-server-from-a-cloud-block-storage-volume/).
...
[Cloud-to-cloud migration](https://support.rackspace.com/support/how-to/cloud-to-cloud-migration/).
