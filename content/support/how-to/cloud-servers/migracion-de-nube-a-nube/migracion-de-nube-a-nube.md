...
El artículo [open cloud reference architectures](https://support.rackspace.com/support/how-to/rackspace-open-cloud-reference-architecture)
...
[Prepare your Cloud Block Storage volume](https://support.rackspace.com/support/how-to/prepare-your-cloud-block-storage-volume).

Para preparar los discos de datos en servidores tipo I/O-optimized puedes ver
[Prepare data disks on a Linux Cloud Servers](https://support.rackspace.com/support/how-to/preparing-data-disks-on-linux-cloud-servers).
...
[Back up your files with rsync](https://support.rackspace.com/support/how-to/backing-up-your-files-with-rsync).
