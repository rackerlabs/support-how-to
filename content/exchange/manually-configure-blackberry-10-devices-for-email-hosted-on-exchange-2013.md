...
1. Locate the **Settings** options from within your home menu.
   ...
   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/1_25_0.png %}" width="234" height="388" />

2. Select **Accounts**.

   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/2_22_0.png %}" width="234" height="388" />
...
3. Select **Advanced** from the bottom of the screen, or you may need to
   ...
   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/3_20_0.png %}" width="234" height="388" />

4. Select **Microsoft&reg; Exchange ActiveSync**.

   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/4_13_0.png %}" width="234" height="388" />
...
5. Enter your full Email Address, Server Address and Password for your
   ...
   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/5_13_0.png %}" width="234" height="388" />
...
6. Confirm which personal information you would like to sync from your
   ...
   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/6_14_0.png %}" width="236" height="389" />

7. Wait for your Blackberry to complete verifying your settings.

   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/7_7_0.png %}" width="234" height="388" />

8. When this is complete, you will see your list of accounts as well as
   the new account that was setup.

   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/8_5_0.png %}" width="236" height="389" />
...
9. To check for new messages, swipe up from the bottom of the screen then
   ...
   <img src="{% asset_path exchange/manually-configure-blackberry-10-devices-for-email-hosted-on-exchange-2013/9_4_0.png %}" width="476" height="388" />
