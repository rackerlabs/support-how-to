...
This article describes how administrators can manage multi-factor authentication for users in Office 365.
...
Requiring all users to use multi-factor authentication helps safeguard access to data and applications in your organization. Multi-factor authentication requires users to provide a second form of authentication when accessing their account. This second form of authentication adds an additional layer of security to the account and helps minimize the chance for account compromises.
...
4.	Select the check box next to the user you wish to enable multi-factor authentication for.

5.	Under quick steps, select **Enable**.

6.	When you are prompted, select **enable multi-factor auth**.

7.	Your user is now able to configure multi-factor authentication for their account.

#### Require a user to use multi-factor authentication

If you wish to require a user to use multi-factor authentication, you will need to enforce multi-factor authentication for their account.
...
4.	Select the check box next to the user you wish to enforce multi-factor authentication for.

5.	Under quick steps, select **Enforce**.

6.	When you are prompted, select **enforce multi-factor auth**, then **close**.

7.	Your user will now be required to configure and use multi-factor authentication for their account.
...
8.	Your user can now login to their Office 365 account and re-register with multi-factor authentication.
...
7.	Your user will now no longer be able to use multi-factor authentication with their account.
