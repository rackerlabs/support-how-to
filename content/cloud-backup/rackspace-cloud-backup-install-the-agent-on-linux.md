...
The following instructions are for the installation or update of the Rackspace
Cloud Backup agent on your Linux server using the Cloud Backup updater. 
...
To schedule and configure backups after the
