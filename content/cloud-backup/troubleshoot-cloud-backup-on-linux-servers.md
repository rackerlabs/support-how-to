...
**Note:** If your server is running a Windows&reg; operating system, see [Cloud backup troubleshooting on Windows](https://support.rackspace.com/how-to/cloud-backup-basic-troubleshooting-on-window-2008-servers/).  
