...
**Note:** If your server is running a Windows&reg; operating system, see [Cloud backup troubleshooting on Windows&reg;](/how-to/cloud-backup-basic-troubleshooting-on-windows-2008-servers).  
