...
GoGrid Linux&reg; cloud servers might be able to [migrate to Rackspace Openstack Public Cloud using InstanceSync](how-to/migrate-gogrid-cloud-servers-to-rackspace-cloud). This method is offered as an unsupported courtesy and is not guaranteed to work for your GoGrid Linux servers.
