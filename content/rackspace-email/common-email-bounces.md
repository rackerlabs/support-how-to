...
### Overview:
Causes of common bounce messages and how to resolve the issue causing them.
...
|550 5.7.23 The message was rejected because of Sender Policy Framework violation| The sender failed SPF policy; has SPF policy of reject| Have the sender verify the sending source to be sure it is compliant with their SPF policy. This can also fail when a message is automatically forwarded or sent as your domain from a webform. |
