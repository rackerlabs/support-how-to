...
|**550 5.7.1** <user@domain.com>: Relay access denied|	This error usually indicates that the address you are sending to does not exist.|	Check the recipient address for any misspellings/typos. Resend the message.|
